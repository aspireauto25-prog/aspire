      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Looking to buy your dream car or sell your current vehicle? We
            connect buyers and sellers of premium cars with our trusted
            platform.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex flex-col sm:flex-row gap-6">
            ...
            <Link
              href={SELL_ROUTE}
              className="flex items-center px-8 py-4 bg-white hover:bg-gray-50 text-primary font-bold rounded-xl transition duration-300 border-2 border-primary shadow-lg hover:shadow-xl"
            >
